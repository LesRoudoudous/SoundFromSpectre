...
public class TableauFrequences extends JPanel implements ActionListener
{
	...
	{ 
		...
		for(int i = 0; i < 9 ; i++)
		{
			NumericTextField t1FreqField = new NumericTextField((i == 3) ? "100" :"0",4);
			NumericTextField t2FreqField = new NumericTextField((i == 3) ? "100" :"0",4);
			NumericTextField t3FreqField = new NumericTextField((i == 3) ? "100" :"0",4);
			NumericTextField t4FreqField = new NumericTextField((i == 3) ? "100" :"0",4);
